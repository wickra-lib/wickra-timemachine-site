<p align="center">
  <a href="https://timemachine.wickra.org"><img src="https://raw.githubusercontent.com/wickra-lib/.github/main/profile/wickra-banner.webp?v=514" alt="Wickra Time Machine — scrub the whole market like a video: every symbol, full order book, rewound to any moment by deterministic re-fold" width="100%"></a>
</p>
...
Source for the Wickra Time Machine site (**[timemachine.wickra.org](https://timemachine.wickra.org)**): hero, per-language API overviews, benchmarks and the in-browser indicator demo.
...
**Wickra Time Machine** — scrub the whole market like a video: every symbol, full order book, rewound to any moment by deterministic re-fold. The library itself is
[`wickra-lib/wickra-timemachine`](https://github.com/wickra-lib/wickra-timemachine); its README carries the install line and a quick start for every language.
...
- **The released version** — the version menu in the nav, the Maven snippet on the landing page and the Java API page — is pulled hourly from [wickra-timemachine's latest release](https://github.com/wickra-lib/wickra-timemachine/releases/latest) by `sync-from-timemachine.yml`.
...
Custom domain `timemachine.wickra.org` is configured in the Cloudflare Pages dashboard.
