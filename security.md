...
- GitHub → the [wickra-timemachine repository](https://github.com/wickra-lib/wickra-timemachine)
...
Wickra Time Machine parses untrusted `ScanSpec` JSON and candle data, so its parser and
...
[SECURITY.md](https://github.com/wickra-lib/wickra-timemachine/blob/main/SECURITY.md)
