 ...
 * shields.io and are best-effort (wickra-timemachine is not published yet, so they
...
const PROFILE = 'https://raw.githubusercontent.com/wickra-lib/.github/main/profile/badges/wickra-timemachine'

// Source of truth for the footer badge row. Mirrors the wickra-timemachine README.
const badges = [
  { alt: 'CI', slug: 'ci', src: `${PROFILE}/ci.svg`, href: 'https://github.com/wickra-lib/wickra-timemachine/actions/workflows/ci.yml' },
  { alt: 'CodeQL', slug: 'codeql', src: `${PROFILE}/codeql.svg`, href: 'https://github.com/wickra-lib/wickra-timemachine/actions/workflows/codeql.yml' },
  { alt: 'codecov', slug: 'codecov', src: `${PROFILE}/codecov.svg`, href: 'https://codecov.io/gh/wickra-lib/wickra-timemachine' },
  { alt: 'GitHub release', slug: 'release', src: 'https://img.shields.io/github/v/release/wickra-lib/wickra-timemachine?logo=github&color=green', href: 'https://github.com/wickra-lib/wickra-timemachine/releases/latest' },
  { alt: 'crates.io', slug: 'crates', src: 'https://img.shields.io/crates/v/wickra-timemachine.svg?logo=rust&color=orange', href: 'https://crates.io/crates/wickra-timemachine' },
  { alt: 'PyPI', slug: 'pypi', src: 'https://img.shields.io/pypi/v/wickra-timemachine.svg?logo=pypi&color=blue', href: 'https://pypi.org/project/wickra-timemachine/' },
  { alt: 'npm', slug: 'npm', src: 'https://img.shields.io/npm/v/wickra-timemachine.svg?logo=npm&color=red', href: 'https://www.npmjs.com/package/wickra-timemachine' },
  { alt: 'NuGet', slug: 'nuget', src: 'https://img.shields.io/nuget/v/Wickra.TimeMachine.svg?logo=nuget&color=blue', href: 'https://www.nuget.org/packages/Wickra.TimeMachine' },
  { alt: 'Maven Central', slug: 'maven', src: 'https://img.shields.io/maven-central/v/org.wickra/wickra-timemachine.svg?logo=apachemaven&color=blue', href: 'https://central.sonatype.com/artifact/org.wickra/wickra-timemachine' },
  { alt: 'Go module', slug: 'go', src: 'https://img.shields.io/github/v/tag/wickra-lib/wickra-timemachine-go.svg?logo=go&logoColor=white&color=00ADD8&label=go', href: 'https://pkg.go.dev/github.com/wickra-lib/wickra-timemachine-go' },
  { alt: 'r-universe', slug: 'r-universe', src: 'https://wickra-lib.r-universe.dev/badges/wickra-timemachine', href: 'https://wickra-lib.r-universe.dev' },
  { alt: 'License: MIT OR Apache-2.0', slug: 'license', src: `${PROFILE}/license.svg`, href: 'https://github.com/wickra-lib/wickra-timemachine#license' },
  { alt: 'OpenSSF Scorecard', slug: 'scorecard', src: `${PROFILE}/scorecard.svg`, href: 'https://scorecard.dev/viewer/?uri=github.com/wickra-lib/wickra-timemachine' },
  { alt: 'OpenSSF Best Practices', slug: 'best-practices', src: `${PROFILE}/best-practices.svg`, href: 'https://www.bestpractices.dev/' },
  { alt: 'Build provenance', slug: 'provenance', src: `${PROFILE}/provenance.svg`, href: 'https://github.com/wickra-lib/wickra-timemachine/attestations' },
  { alt: 'Verified across 10 languages', slug: 'verified', src: `${PROFILE}/verified.svg`, href: 'https://github.com/wickra-lib/wickra-timemachine/tree/main/golden' },
]
...
for (const b of badges) {
  try {
    if (b.slug === 'release') {
      const v = (await ghJson('repos/wickra-lib/wickra-timemachine/releases/latest')).tag_name
      b.src = `https://img.shields.io/badge/release-${escBadge(v)}-green?logo=github`
    } else if (b.slug === 'go') {
      const v = (await ghJson('repos/wickra-lib/wickra-timemachine-go/tags'))[0]?.name
